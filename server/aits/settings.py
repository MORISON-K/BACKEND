...
try:
    ...
    # In production (like Heroku), we don't need dotenv
    pass
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Make sure whitenoise is after security and before other middleware
